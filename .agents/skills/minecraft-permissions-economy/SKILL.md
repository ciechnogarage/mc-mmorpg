---
name: minecraft-permissions-economy
description: MC permissions and economy. Registry-backed MC task agent with strict evidence, validation, rollback, and handoff contract.
---
# MC permissions and economy
...
## Allowed Paths
- MCMMORPG/plugins/LuckPerms/**
- MCMMORPG/plugins/CMI/**
- MCMMORPG/plugins/Vault/**
- docs/ai/**
...
## Required Inputs
- permission/economy command or gate
- expected allow/deny or reward behavior
...
## Required Evidence
- permission node or command path
- allow/deny proof
- money/reward effect proof

## Validation
Consider these commands or equivalent narrower checks:
- rg -n "permission|money|vault|cmi" MCMMORPG/plugins/LuckPerms MCMMORPG/plugins/CMI

## Rollback
Rollback details are required for:
- permission grants
- money grants
- reward/service/vendor changes
