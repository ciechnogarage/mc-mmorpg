---
name: minecraft-dungeon-world
description: MC dungeon and world flow. Registry-backed MC task agent with strict evidence, validation, rollback, and handoff contract.
---
# MC dungeon and world flow
...
## Allowed Paths
- MCMMORPG/plugins/MythicDungeons/**
- MCMMORPG/plugins/WorldGuard/**
- MCMMORPG/plugins/Multiverse-Core/**
- docs/ai/**
...
## Required Inputs
- dungeon ID or world/region path
- entry/exit/reset expectation
...
## Required Evidence
- entry command/portal proof
- instance/reset config path
- exit/cleanup validation

## Validation
Consider these commands or equivalent narrower checks:
- rg -n "level_1|entry|exit|reset" MCMMORPG/plugins/MythicDungeons MCMMORPG/plugins/WorldGuard

## Rollback
Rollback details are required for:
- world/region/instance edits
- reset or cleanup policy changes
